...
# ============================================================================
#
# CameraAcquisition.py shows how to capture images from
...
NUM_IMAGES = 100000000000000000  # number of images to grab
...
def acquire_images(cam_list):
    ...
    for i in range(len(cam_list)):
        if (cam_list[i].DeviceSerialNumber.ToString() == args.id):
            cam = cam_list[i]
    ...
    pub0 = rospy.Publisher('image' + args.id, Image, queue_size=10)
    for n in range(NUM_IMAGES):
        ...
        if image_result.IsIncomplete():
            ...
            print(args.id + ' Camera grabbed image %d' % (n))
...
parser = argparse.ArgumentParser(description='id of the camera')
