...
NUM_IMAGES = 100000000  # number of images to grab
...
def main():
    ...
    t1 = threading.Thread(target=run_single_camera, args=(cam_list[0],))
    t2 = threading.Thread(target=run_single_camera, args=(cam_list[1],))
    t1.start()
    t2.start()
    t1.join()
    t2.join()
